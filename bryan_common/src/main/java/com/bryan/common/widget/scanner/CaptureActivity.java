package com.bryan.common.widget.scanner;
...
//        Toast.makeText(CaptureActivity.this,result,Toast.LENGTH_SHORT).show();
        if (TextUtils.isEmpty(result)) {
            ...
            intent.putExtra(SCANNER_QR_CODE_RESULT, result);
...
//                //自定义的二维码格式
//                String content = resultString.substring(10, resultString.length());
//                try {
...
//                                Intent intent = new Intent(mContext, NewUserDetailActivity.class);
...
//                    }
//                } catch (Exception e) {
//                    String url2 = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=解码出错";
//                    startActivity(WebActivity.newIntent(mContext, url2, "扫码结果"));
//                    finish();
//                }
//            } else {
...
//    }
//
//    private void handleMeetRoomQrCode(String resultString) {
//        resultString += "&uid=" + UserUtil.getInstance().getUser().getToken();
//        LoadDialog.show(mContext);
//        new RequestBean(resultString, RequestBean.METHOD_GET)
//                .setParseMode(RequestBean.ParseMode.FALSE)
...
//                            switch (code) {
//                                case 0:
//                                    String successResult = jsonObject.optString("data");
//                                    org.json.JSONObject successJson = new org.json.JSONObject(successResult);
//                                    String successUrl = successJson.optString("url");
//                                    startActivity(WebActivity.newIntent(mContext, successUrl, "扫码结果"));
//                                    finish();
//                                    break;
//                                case 1:
...
//                                        content = dataJson.optString("msg");
//                                    }
//                                    String url6 = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=" + content;
//                                    startActivity(WebActivity.newIntent(mContext, url6, "扫码结果"));
//                                    finish();
//                                    break;
//                                case -1:
//                                    String url = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=" + "服务器内部出错";
//                                    startActivity(WebActivity.newIntent(mContext, url, "扫码结果"));
//                                    finish();
//                                    break;
//                                case -2:
//                                    String url1 = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=" + "应用服务器内部出错";
//                                    startActivity(WebActivity.newIntent(mContext, url1, "扫码结果"));
//                                    finish();
//                                    break;
//                                case 1001:
//                                case 1000:
//                                    String url2 = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=" + "网络出错，请稍后再试";
//                                    startActivity(WebActivity.newIntent(mContext, url2, "扫码结果"));
//                                    finish();
//                                    break;
//                                default:
//                                    String url3 = "https://qrcode.iqcloud.cc:18588/scanFail.html?message=" + "未知错误，请稍后再试";
//                                    startActivity(WebActivity.newIntent(mContext, url3, "扫码结果"));
//                                    finish();
//                                    break;
//                            }
