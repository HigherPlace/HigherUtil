package com.bryan.common.widget.weave;
...
/**
 * 多重水波纹
 * //参考地址：https://github.com/scwang90/MultiWaveHeader
...
public class MultiWaveHeader extends ViewGroup {
    ...
    public MultiWaveHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mIsCircle = ta.getBoolean(R.styleable.MultiWaveHeader_mwhIsCircle, false);
