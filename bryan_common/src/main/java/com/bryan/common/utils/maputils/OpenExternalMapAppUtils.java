package com.bryan.common.utils.maputils;
...
import com.bryan.common.utils.popwindow.SelectPopupWindow;
import com.bryan.common.utils.web.TbWebViewActivity;
...
//            "com.baidu.BaiduMap"};     //百度
    private static String[] paks = new String[]{
            "com.baidu.BaiduMap"};     //百度
...
//            }
    ...
    public static void openBaiduMarkerMap(Context activity, String longitude, String latitude,
        ...
        Intent intent = new Intent("android.intent.action.VIEW",
                Uri.parse("baidumap://map/marker?location=" + latitude + "," +
    ...
    public static void openBaiduCenterMap(Context activity, String cLongitude, String cLatitude,
        ...
        Intent intent = new Intent("android.intent.action.VIEW",
                Uri.parse("baidumap://map/show?center=" + cLatitude + "," +
    ...
    public static void openBaiduiDrectionMap(Context activity, String sLongitude, String sLatitude, String sName,
        ...
        Intent intent = new Intent("android.intent.action.VIEW",
                Uri.parse("baidumap://map/direction?origin=name:" +
